...
export class CustomSourceProvider extends BaseOverlaySourceProvider {
	...
	private overlayMetadata = {
		...
		imageUrl: "http://localhost/mp-gw/s3%3A%252F%252Fmp-images%252F10056.tiff/band/Pixel/{z}/{y}/{x}.jpeg",
		thumbnailUrl: "http://localhost/mp-gw/s3%3A%252F%252Fmp-images%252F10056.tiff/band/Pixel/0/0/0.jpeg",
